  ...
  const [dataBase, setDataBase] = useState([
    {
      ...
      img: '/images/1.jpeg',
      title: 'Заголовок',
      description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab adipisci, debitis dolore earum Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab adipisci, debitis dolore earum.',
      ...
      <Router>
        <>
          ...
          <Routes>
            ...
            <Route path='/examples' exact element={<ExamplesList dataBase={dataBase} addToFav={addToFav}/>}/>
            <Route path='/examples/:id' element={<FullExample dataBase={dataBase}/>} />
            <Route path='/favorites' exact element={<FavoritesList favorites={favorites} removeFromFav={removeFromFav}/>}/>
